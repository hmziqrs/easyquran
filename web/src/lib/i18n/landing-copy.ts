...
import { landing_badge, landing_coming, landing_hero_intro, landing_hero_title, landing_primary_cta, landing_roadmap_audio_body, landing_roadmap_audio_title, landing_roadmap_content_body, landing_roadmap_content_title, landing_roadmap_eyebrow, landing_roadmap_intro, landing_roadmap_native_body, landing_roadmap_native_title, landing_roadmap_sync_body, landing_roadmap_sync_title, landing_roadmap_title, landing_secondary_cta, landing_today_eyebrow, landing_today_intro, landing_today_title, landing_value_authentic_body, landing_value_authentic_title, landing_value_free_body, landing_value_free_title, landing_value_instant_body, landing_value_instant_title, landing_value_size_body, landing_value_size_title, seo_home_description, seo_home_image_alt, seo_home_title } from "$lib/i18n/m/landing";
