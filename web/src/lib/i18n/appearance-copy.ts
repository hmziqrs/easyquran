...
import { accent_azure_label, accent_emerald_label, accent_gold_label, accent_plum_label, surface_contrast_label, surface_contrast_note, surface_ink_label, surface_ink_note, surface_mocha_label, surface_mocha_note, surface_paper_label, surface_paper_note, surface_slate_label, surface_slate_note, tweaks_accent, tweaks_analytics, tweaks_background, tweaks_clear, tweaks_close_panel, tweaks_copied, tweaks_copy_css, tweaks_custom_colours, tweaks_data_privacy, tweaks_derived_colours, tweaks_mode, tweaks_off, tweaks_on, tweaks_performance, tweaks_performance_reload, tweaks_pop, tweaks_reset, tweaks_settings, tweaks_surface, tweaks_theme } from "$lib/i18n/m/appearance";
import { tweaks_accent_option, tweaks_colour_input, tweaks_colour_label, tweaks_preset, tweaks_reset_to_preset, tweaks_toggle_status } from "$lib/i18n/m/controls";
