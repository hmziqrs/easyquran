...
import { marketingDirection, marketingHomeHref, marketingReaderHomeHref } from "$lib/i18n/marketing-copy";
import { brand_home_label, footer_about, footer_blurb, footer_bookmarks, footer_built_by, footer_company_heading, footer_company_label, footer_contact, footer_faq, footer_legal_heading, footer_legal_label, footer_privacy, footer_product_heading, footer_product_label, footer_project_by, footer_read_quran, footer_social_x, footer_terms, footer_whats_inside, nav_account, nav_appearance, nav_change_language, nav_close_panel, nav_language, nav_offline_detail, nav_offline_label, nav_offline_title, nav_open_panel, nav_primary_label, nav_search_quran, nav_sign_in, nav_site_panel, nav_theme, nav_toggle_theme, skip_to_content, tweaks_customize_appearance } from "$lib/i18n/m/chrome";
