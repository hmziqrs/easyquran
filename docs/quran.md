...
- **normalize** (`quran/normalize.rs` ↔ web): drop combining marks U+064B–U+0658, U+0670 (superscript alef — dropped, not folded, to match the web's `/\p{Mn}/u`), U+0640 (tatweel), and Quranic signs **U+06D6–U+06DC, U+06DE, U+06DF–U+06E8, U+06E9, U+06EA–U+06ED**. Fold `آ أ إ ٱ → ا`, `ى → ي`, `ة → ه`.
